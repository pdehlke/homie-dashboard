...
3. Back up the live directory, then SFTP the changed file(s) to
   ...
   rename. SSH/SFTP is `root@hass.ehlke.net:2222`; the key is `$HA_EDIT_KEY`.
...
Real output, run 2026-08-23 against release `20260817.2`:
